...
\\
\begin{longtable}{|p{1cm}|p{7em}|p{2em}|p{2em}|p{1cm}|p{3cm}|p{4.5cm}|}
\hline
     ...
     \multirow{3}{}{US001} & \multirow{3}{7em}{As a user, I want to find the position of a given number in the sequence of positive integers.} & \multirow{3}{}{5} & \multirow{3}{}{1} & TC001 & Start the calculator application. Enter a random positive integer number. Select "Find Position in Champernowne Constant" from the options menu & The Calculator application should display a question, please enter a Number. After entering the number, the application should display a list of options, "Find Position in Champernowne Constant", Square the number, Square root of a number, Addition, Subtraction, Save the number etc. The application should display the message "The position of the number X is Y", where X is the random number entered and Y is the position of that number in Champernowne Constant(Sequence of positive integers).\\\cline{5-7}
     & & & & TC002 & Start the calculator application. Enter a random String. & The application should display a message 'Invalid Number", Please enter a positive integer number.\\\cline{5-7}
     & & & & TC003 & Start the calculator application. Enter a random positive decimal number. Select "Find Position in Champernowne Constant" from the options menu. & The application should display a message "Invalid Number", Please enter a positive integer number.\\\hline
     \multirow{3}{}{US002} & \multirow{3}{7em}{As a user, I want to, save the random number entered for future use, find the square of the given number, and display the squared saved numbers.} & \multirow{3}{}{4} & \multirow{3}{}{2} & TC004 & Start the calculator application. Enter a random positive integer number. Select "Save the number". Select "Find the square of the number". Select "Display the saved number'. & The Calculator application should display a question, please enter a Number. After entering the number, the application should display a list of options, "Find Position in Champernowne Constant", Square the number, Square root of a number, Addition, Subtraction, Save the number etc. The application should display the message "Number X saved successfully", where X is the random number entered and display the calculator options. The application should calculate the square of the number and display the squared number along with the saved number X.\\\cline{5-7}
    & & & & TC005 & Start the calculator application. Enter a random positive decimal number.Select "Find Position in Champernowne Constant" from the options menu. & The application should display a message "Invalid Number", Please enter a positive integer number.\\\hline
     \multirow{3}{}{US003} & \multirow{3}{7em}{As a user, I want to find the position of a number in a sequence of positive integers, save the number for future use, find the square root of the given number, subtract the saved number with the immediate previous result and display the results.} & \multirow{3}{}{3} & \multirow{3}{}{4} & TC006 & Start the calculator application. Enter a random positive integer number. Select "Find the position of the number in Champernowne Constant". Select "Save the number". Select "Find the square root of the number". Select "Subtract". Select "Saved number". & The Calculator application should display a question, please enter a Number. After entering the number, the application should display a list of options, "Find Position in Champernowne Constant", Square the number, Square root of a number, Addition, Subtraction, Save the number etc. The application should display the message "The position of the number X is Y", where X is the random number entered and Y is the position of that number in Champernowne Constant(Sequence of positive integers). The application should calculate the square root of the number and display the squared number. The application should display the Calculator options such as "Use Saved number" or "Enter new number". The application should display the result "The subtraction of Y and X is Z", where Y is the square root of the number that was generated earlier, X is the saved number and Z is the subtracted result.\\\cline{5-7}
     & & & & TC007 & Start the calculator application. Enter a random positive decimal number. Select "Find Position in Champernowne Constant" from the options menu. & The application should display a message "Invalid Number", Please enter a positive integer number.\\\hline
     \multirow{3}{}{US004} & \multirow{3}{7em}{As a user, I want to randomly enable or disable an array of N number of lights, if the light to be turned on is defined by number 1 and the light to be kept off is defined by 0, to generate a random sequence of 0's and 1's, I want a calculator that can generate binary digits to the length of the number provided.} & \multirow{3}{}{2} & \multirow{3}{}{8} & TC008 & Start the calculator application. Enter a random positive integer number. Select "Generate Binary Champernowne constant". & The Calculator application should display a question, please enter a Number. After entering the number, the application should display a list of options, "Find Position in Champernowne Constant", Square the number, Square root of a number, Addition, Subtraction, Generate Binary Champernowne Constant etc. The calculator application should display the Champernowne Constant of Base 2 generated to the length of the given number.\\\cline{5-7}
     & & & & TC009 & Start the calculator application. Enter a random positive decimal number. Select "Find Position in Champernowne Constant" from the options menu. & The application should display a message "Invalid Number", Please enter a positive integer number.\\\hline
     \multirow{3}{}{US005} & \multirow{3}{7em}{As a user, I want to find the square of a number, find the positions of the actual number and squared numbers and display the number of digits between the positions of 2 numbers.} & \multirow{3}{}{1} & \multirow{3}{}{16} & TC010 & Start the calculator application. Enter a random positive integer number. Select "Find the position of the Number in Champernowne Constant". Select "Save the Number". Select "Find the square of a Number". Select "Find the position of the number in Champernowne Constant". Select "Find the Number of digits between 2 numbers". Select "Saved Number" and "Previous result". & The Calculator application should display a question, please enter a Number. After entering the number, the application should display a list of options, "Find Position in Champernowne Constant", Square the number, Square root of a number, Addition, Subtraction, Save the number etc. The application should display the message "The position of the number X is Y", where X is the random number entered and Y is the position of that number in Champernowne Constant. The calculator should display the message "Number I Saved successfully" where I is the last generated result. The application should display the result of the squared number. The application should display the message "The position of the number X is Y", where X is the random number entered and Y is the position of that number in Champernowne Constant. The application should display the options Choose 2 numbers from below "Saved Number", "Previous Result" or "Enter a Number". The application should display the message "Number of digits between X and Y is Z" where X is the saved number, Y is the previous result and Z is the number of digits between X and Y in Champernowne Constant.\\\cline{5-7}
     & & & & TC011 & Start the calculator application. Enter a random positive decimal number.Select "Find Position in Champernowne Constant" from the options menu. & The application should display a message "Invalid Number", Please enter a positive integer number.\\\hline
